...
package com.utsdev.capturetheflag.beaconkeeper.receiver;
...
{
    public static final String TAG = "utsdev-BeaconReceiver";
    ...
    protected void onFoundBeacon(Context ctx, BeaconEntity beaconEntity) {
        Log.d("BeaconReceiver", "Found a beacon!!!!!!!!" + beaconEntity.getIBeacon().toString());
    }
